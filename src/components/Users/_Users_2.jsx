...
export default function Users(){
    ...
    const fnAdd = () =>{
        //let _id = emailList[emailList.length - 1].id + 1;
        let _uid = uuidv4()
    ...
    return(
        ...
        <div>
            <label>email:</label>
            <input type="text" name="email" value={email} onChange={emailHandler} placeholder="add email"/>      
        </div>
        <div>
            <label>name:</label>
            <input type="text" name="name" value={name} onChange={nameHandler} placeholder="add name"/>      
        </div>
        <br/>
        <br/>
